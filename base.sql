...
-- -----------------------------------------------------
-- Table `Banco`.`Tarjetas de Crédito`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Banco`.`Tarjetas de Crédito` ;

CREATE TABLE IF NOT EXISTS `Banco`.`Tarjetas de Crédito` (
...
-- -----------------------------------------------------
-- Table `Banco`.`Clientes_has_Cuentas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Banco`.`Clientes_has_Cuentas` ;

CREATE TABLE IF NOT EXISTS `Banco`.`Clientes_has_Cuentas` (
  `Clientes_idCliente` INT NOT NULL,
  `Clientes_Usuarios_idUsuario` INT NOT NULL,
  `Cuentas_idCuenta` INT NOT NULL,
  PRIMARY KEY (`Clientes_idCliente`, `Clientes_Usuarios_idUsuario`, `Cuentas_idCuenta`),
  INDEX `fk_Clientes_has_Cuentas_Cuentas1_idx` (`Cuentas_idCuenta` ASC) VISIBLE,
  INDEX `fk_Clientes_has_Cuentas_Clientes1_idx` (`Clientes_idCliente` ASC, `Clientes_Usuarios_idUsuario` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `Banco`.`Cuentas_has_Promociones`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Banco`.`Cuentas_has_Promociones` ;

CREATE TABLE IF NOT EXISTS `Banco`.`Cuentas_has_Promociones` (
  `Cuentas_idCuenta` INT NOT NULL,
  `Promociones_idPromociones` INT NOT NULL,
  PRIMARY KEY (`Cuentas_idCuenta`, `Promociones_idPromociones`),
  INDEX `fk_Cuentas_has_Promociones_Promociones1_idx` (`Promociones_idPromociones` ASC) VISIBLE,
  INDEX `fk_Cuentas_has_Promociones_Cuentas1_idx` (`Cuentas_idCuenta` ASC) VISIBLE,
  CONSTRAINT `fk_Cuentas_has_Promociones_Cuentas1`
    FOREIGN KEY (`Cuentas_idCuenta`)
    REFERENCES `Banco`.`Cuentas` (`idCuenta`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Cuentas_has_Promociones_Promociones1`
...
-- -----------------------------------------------------
-- Table `Banco`.`Recibos Domiciliarios`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Banco`.`Recibos Domiciliarios` ;

CREATE TABLE IF NOT EXISTS `Banco`.`Recibos Domiciliarios` (
...
-- -----------------------------------------------------
-- Table `Banco`.`Notificaciones de Recibos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Banco`.`Notificaciones de Recibos` ;

CREATE TABLE IF NOT EXISTS `Banco`.`Notificaciones de Recibos` (
  ...
  CONSTRAINT `fk_Notificaciones de Recibos_Recibos Domiciliarios1`
    ...
    REFERENCES `Banco`.`Recibos Domiciliarios` (`idRecibosDomiciliarios`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Banco`.`Sucursales_has_Usuarios`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Banco`.`Sucursales_has_Usuarios` ;

CREATE TABLE IF NOT EXISTS `Banco`.`Sucursales_has_Usuarios` (
  `Sucursales_idSucursal` INT NOT NULL,
  `Usuarios_idUsuario` INT NOT NULL,
  PRIMARY KEY (`Sucursales_idSucursal`, `Usuarios_idUsuario`),
  INDEX `fk_Sucursales_has_Usuarios_Usuarios1_idx` (`Usuarios_idUsuario` ASC) VISIBLE,
  INDEX `fk_Sucursales_has_Usuarios_Sucursales1_idx` (`Sucursales_idSucursal` ASC) VISIBLE,
  CONSTRAINT `fk_Sucursales_has_Usuarios_Sucursales1`
    FOREIGN KEY (`Sucursales_idSucursal`)
    REFERENCES `Banco`.`Sucursales` (`idSucursal`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Sucursales_has_Usuarios_Usuarios1`
    FOREIGN KEY (`Usuarios_idUsuario`)
    REFERENCES `Banco`.`Usuarios` (`idUsuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
