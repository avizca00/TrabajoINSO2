...
CREATE TABLE IF NOT EXISTS `Banco`.`ClientesCuentas` (
  `idClientesCuentas` INT NOT NULL,
  `Cuentas_idCuenta` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Banco`.`CuentasPromociones` (
  `idCuentasPromociones` INT NOT NULL,
...
START TRANSACTION;
USE `Banco`;
INSERT INTO `Banco`.`Sucursales` (`idSucursal`, `nombre`, `ubicacion`, `telefono`, `correo_electronico`) VALUES (1, 'Leon1', 'León Centro', '686938854', 'leondellLC@gmail.com');
INSERT INTO `Banco`.`Sucursales` (`idSucursal`, `nombre`, `ubicacion`, `telefono`, `correo_electronico`) VALUES (2, 'Leon2', 'León Sur', '968856954', 'leondellLS@gmail.com');
INSERT INTO `Banco`.`Sucursales` (`idSucursal`, `nombre`, `ubicacion`, `telefono`, `correo_electronico`) VALUES (3, 'Ponfe1', 'Ponfe Centro', '987654321', 'leondellPF@gmail.com');
