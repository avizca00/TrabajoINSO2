...
CREATE TABLE IF NOT EXISTS `Banco`.`NotificacionesRecibos` (
  ...
  PRIMARY KEY (
    ...
    `Recibos Domiciliarios_idRecibos Domiciliarios`
  ),
  INDEX `fk_Notificaciones de Recibos_Recibos Domiciliarios1_idx` (
    `Recibos Domiciliarios_idRecibos Domiciliarios` ASC
  ) VISIBLE,
  CONSTRAINT `fk_Notificaciones de Recibos_Recibos Domiciliarios1` FOREIGN KEY (`Recibos Domiciliarios_idRecibos Domiciliarios`) REFERENCES `Banco`.`RecibosDomiciliarios` (`idRecibosDomiciliarios`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
-- -----------------------------------------------------
