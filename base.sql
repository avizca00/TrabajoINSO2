...
CREATE TABLE IF NOT EXISTS `Banco`.`Prestamos` (
  ...
  CONSTRAINT `fk_Clientes_has_Empleados_Empleados1` FOREIGN KEY (`Empleados_idEmpleado`, `idPrestamo`) REFERENCES `Banco`.`Empleados` (`idEmpleado`, `Usuarios_idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
