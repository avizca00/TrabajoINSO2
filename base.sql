...
CREATE TABLE IF NOT EXISTS `Banco`.`NotificacionesRecibos` (
  ...
  `descripcion` VARCHAR(255) NOT NULL,
  `fecha` DATE NOT NULL,
  PRIMARY KEY (`idNotificacionesRecibos`, `RecibosDomiciliarios_idRecibosDomiciliarios`),
  INDEX `fk_Notificaciones de Recibos_Recibos Domiciliarios1_idx` (`RecibosDomiciliarios_idRecibosDomiciliarios` ASC) VISIBLE,
  CONSTRAINT `fk_Notificaciones de Recibos_Recibos Domiciliarios1`
    FOREIGN KEY (`RecibosDomiciliarios_idRecibosDomiciliarios`)
...
CREATE TABLE IF NOT EXISTS `Banco`.`Prestamos` (
  ...
  `Cuentas_idCuenta` INT NOT NULL,
  PRIMARY KEY (`idPrestamo`, `Empleados_idEmpleado`, `Empleados_Usuarios_idUsuario`, `Cuentas_idCuenta`),
  INDEX `fk_Prestamos_Empleados1_idx` (`Empleados_idEmpleado` ASC, `Empleados_Usuarios_idUsuario` ASC) VISIBLE,
  INDEX `fk_Prestamos_Cuentas1_idx` (`Cuentas_idCuenta` ASC) VISIBLE,
  CONSTRAINT `fk_Prestamos_Empleados1`
    FOREIGN KEY (`Empleados_idEmpleado` , `Empleados_Usuarios_idUsuario`)
