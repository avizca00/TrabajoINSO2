...
CREATE TABLE IF NOT EXISTS `Banco`.`ClientesCuentas` (
  ...
  INDEX `fk_ClientesCuentas_Clientes1_idx` (`Clientes_idCliente` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_ClientesCuentas_Clientes1` FOREIGN KEY (`Clientes_idCliente`) REFERENCES `Banco`.`Clientes` (`idCliente`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
-- -----------------------------------------------------
